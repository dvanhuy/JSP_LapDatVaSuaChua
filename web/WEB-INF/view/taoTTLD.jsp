        ...
        <main>
            ...
            <div class="container_main_content">
                <div class="first_container_ct">
                    ...
                    <div>
                        <label for="gialapdat">Giá lắp đặt</label>
                        <input type="text" id="gialapdat" name="gialapdat">
                    </div>
                    <div>
                        <label for="motacongviec">Mô tả công việc</label>
                        <textarea id="motacongviec" name="motacongviec"></textarea>
                    </div>
                </div>
            </div>

            <div class="footer_main_button">
                <input type="submit" value="THÊM" name="actionbt">
            </div>
        </main>
    </form>
...
.first_container_ct select option{
    padding-top: 10px;
}
